...
public class GuiShopPageFunds : GuiShopPageBase
{
	// GUIVIEW INTERFACE
	...
	{
		return GuiShopPageFunds.GetFunds();
	}
	...
	static string GetProductId(ShopItemId shopItem)
	{
		return FundSettingsManager.Instance.Get((E_FundID)(shopItem.Id)).GUID.ToString();
	}
