...
class GOAPGoalUseGadget : GOAPGoal
{
	public GOAPGoalUseGadget(AgentHuman owner) : base(E_GOAPGoals.UseGadget, owner)
	{
	}
	...
	{
		WorldStateProp prop = worldState.GetWSProperty(E_PropKey.UseGadget);
